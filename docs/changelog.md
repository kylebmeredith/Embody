...
- **Phase 4 pending.** Tree/flat list toggle, dirty filter, Save-all-force, Rebuild-all-from-TDN, per-row save/reload icons, and (optionally) a custom popup panel for the action menu.
