...
- **Phases 2.5, 4, and 5b.2 pending.** 2.5 (default save folder + contextual action menu), 4 (tree/flat list toggle + dirty filter + TDN reload), and 5b.2 (TD UI cleanup: delete tagger COMP, delete window_tagging_menu, remove tag custom params from Embody COMP, save project) live in subsequent commits.
